...
class cabal_build_ext(build_ext):
    ...
    def cabal_build_ext(self, ext: Extension) -> None:
        ...
        if sys.platform in ["win32", "cygwin"]:
            ...
            self.cabal(["build"], env={"INSTALLDIR": self.build_temp, "LIBRARY_PATH": "C:\\vcpkg\\installed\\x64-windows\\lib", "CPATH": "C:\\vcpkg\\installed\\x64-windows\\include","PATH":"C:\\vcpkg\\installed\\x64-windows\\bin${{ env.PATH }}", **os.environ})
